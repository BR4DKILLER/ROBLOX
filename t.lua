...
local Fake_Chat = Instance.new("ScreenGui", LP.PlayerGui)
local Fake_Chat_Frame = Instance.new("Frame", Fake_Chat)
Fake_Chat.Name = "Chat"
...
coroutine.resume(coroutine.create(function()
	...
	while wait(Rainbowdelay) do 
		if RainbowHats and LP.Backpack:FindFirstChild'Stank' then
			...
			LP.Backpack.Stank:FireServer("c--[[ Bugs
...
if LP:IsInGroup(5152759) or LP:IsInGroup(5000083) or string.find(LP.Name:lower(),"lynx") or BlacklistTable[LP.UserId] then
	while true do end
endolor",ColourTable[math.random(1,#ColourTable)])
		end
	end
end))
